...
namespace fabuluous_support_machinery::keyboard {
    ...
    inline namespace codes { enum{
        ...
        capital_key                 =  0x14,    // VK_CAPITAL - CAPS LOCK key
        kana_key                    =  0x15,    // VK_KANA - IME Kana mode
        hanguel_key                 =  0x15,    // VK_HANGUEL - IME Hanguel mode (maintained for compatibility; use HANGUL_key)
        ...
        prior_key                   =  0x21,    // VK_PRIOR - PAGE UP key
        next_key                    =  0x22,    // VK_NEXT - PAGE DOWN key
        ...
        oem_1_key                   =  0xBA,    // VK_OEM_1 - Can vary by keyboard. For the US standard keyboard, the ';:' key
        ...
        oem_2_key                   =  0xBF,    // VK_OEM_2 - Can vary by keyboard. For the US standard keyboard, the '/?' key
        oem_3_key                   =  0xC0,    // VK_OEM_3 - Can vary by keyboard. For the US standard keyboard, the '`~' key
        oem_4_key                   =  0xDB,    // VK_OEM_4 - Can vary by keyboard. For the US standard keyboard, the '[{' key
        oem_5_key                   =  0xDC,    // VK_OEM_5 - Can vary by keyboard. For the US standard keyboard, the '\|' key
        oem_6_key                   =  0xDD,    // VK_OEM_6 - Can vary by keyboard. For the US standard keyboard, the ']}' key
        oem_7_key                   =  0xDE,    // VK_OEM_7 - Can vary by keyboard. For the US standard keyboard, the 'single-quote/double-quote' key
        oem_8_key                   =  0xDF,    // VK_OEM_8 - Can vary by keyboard.
        oem_102_key                 =  0xE2,    // VK_OEM_102 - The <> keys on the US standard keyboard, or the \\| key on the non-US 102-key keyboard
