...
#   include <fsm/@wrapped/3rd-party-lib/fmtlib/_details/fmt-core.via-original-fmt-library.hpp>
#else
#   include <fsm/@wrapped/3rd-party-lib/fmtlib/_details/fmt-core.via-stdlib.hpp>
#endif
