...
#include <fsm/core/headers/misc/support-for-collections/FSM_ITS_RANGE.hpp>
#define $its_range                  FSM_ITS_RANGE

#include <fsm/core/headers/constructs/declarations/FSM_ENABLE_IF.hpp>
#define $enable_if                  FSM_ENABLE_IF

#include <fsm/core/headers/constructs/declarations/FSM_NOT_USING.hpp>
#define $not_using                  FSM_NOT_USING

#include <fsm/core/headers/constructs/declarations/FSM_NS_FROM.hpp>
#define $ns_from                    FSM_NS_FROM

#include <fsm/core/headers/constructs/declarations/FSM_TYPE_OF.hpp>
#define $type_of                    FSM_TYPE_OF

#include <fsm/core/headers/constructs/declarations/FSM_WITH.hpp>
#define $with                       FSM_WITH
#define $with_mutable               FSM_WITH_MUTABLE

#include <fsm/core/headers/constructs/introspection/FSM_FUNCTION_NAME.hpp>
#define $function_name              FSM_FUNCTION_NAME

#include <fsm/core/headers/failure/expressing/FSM_FAIL.hpp>
...
#include <fsm/core/headers/constructs/flow-control/FSM_IF.hpp>
