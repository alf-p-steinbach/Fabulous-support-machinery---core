...
#include <fsm/text-io/headers/keyboard/continuous-effect-keys.hpp>      // Continuous_key_effect::Enum
#include <fsm/text-io/headers/keyboard/Key_code.hpp>                    // Key code names
#include <fsm/text-io/headers/keyboard/key-modifiers.hpp>               // Key_modifier, Key_modifier_set
#include <fsm/core/headers/text/encoding/u8/Code_point_.hpp>            // Code_point_
#include <fsm/core/headers/meta-type/class-kinds.hpp>                   // Polymorphic
