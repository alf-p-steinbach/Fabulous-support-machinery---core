...
#include <fsm/core/headers/meta-type/Typelist_.hpp>                     // Typelist_
#include <fsm/core/headers/meta-type/type-inspectors.hpp>               // type_is_a_, Bare_
#include <fsm/text-io/headers/console/event-classes.hpp>
