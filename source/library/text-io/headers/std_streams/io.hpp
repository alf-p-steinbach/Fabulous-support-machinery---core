...
#include <fsm/core/headers/failure/x-classes/End_of_file.hpp>               // End_of_file
#include <fsm/core/headers/text/string_building.hpp>                        // string_from
#include <fsm/text-io/headers/Stream_id.hpp>                                // Output_stream_id
