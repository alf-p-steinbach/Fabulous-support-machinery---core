...
#include <fsm/text-io/keyboard/continuous-effect-keys.hpp>      // Continuous_key_effect::Enum
#include <fsm/text-io/keyboard/Key_code.hpp>                    // Key code names
#include <fsm/text-io/keyboard/key-modifiers.hpp>               // Key_modifier, Key_modifier_set
#include <fsm/core/text/encoding/u8/Cp_bytes_.hpp>            // Cp_bytes_
#include <fsm/core/meta-type/class-kinds.hpp>                   // Polymorphic
...
namespace fabulous_support_machinery::console::_definitions {
    ...
    {
        u8::Cp_bytes  m_code_point;

    public:
        Keyboard_unicode_event(
            const Key_code::Enum       code,
            const u8::Cp_bytes        value,
        ...
        auto unicode() const -> const u8::Cp_bytes& { return m_code_point; }
    };
