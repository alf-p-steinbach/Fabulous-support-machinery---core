...
#include <fsm/text-io/std_streams/io.hpp>       // ~

#include <fsm/core/constructs/declarations/type_builders.hpp>       // const_, in_
#include <fsm/core/failure/detecting/hopefully.hpp>                 // hopefully
#include <fsm/core/failure/expressing/FSM_FAIL.hpp>                 // FSM_FAIL
#include <fsm/core/misc/support-for-collections/size-functions.hpp>      // int_size_of, is_empty
#include <fsm/text-io/console/input.hpp>                            // console::input
#include <fsm/text-io/std_streams/is_console_stream.hpp>            // is_console_stream
