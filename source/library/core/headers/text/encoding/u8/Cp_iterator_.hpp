...
#include <fsm/core/headers/misc/support-for-collections/Iterator_pair_.hpp>     // Iterator_pair_
...
#include <fsm/core/headers/text/encoding/u8/Cp_bytes_ref_.hpp>                  // u8::Cp_bytes_ref_, tag::*
#include <fsm/core/headers/text/encoding/u8/basic-sequence-functions.hpp>       // u8::*
#include <fsm/core/headers/meta-type/type-inspectors.hpp>                       // bits_per_
